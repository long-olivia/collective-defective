...
gpt_bars=plt.bar(np.arange(len(gpt_basic_final)), gpt_basic_final, width=width, yerr=gpt_SE_final, capsize=8, color='powderblue', label='GPT-4o')
claude_bars=plt.bar(np.arange(len(claude_basic_final)) + width, claude_basic_final, width=width, yerr=claude_SE_final, capsize=8, color='teal', label='Sonnet 4')
