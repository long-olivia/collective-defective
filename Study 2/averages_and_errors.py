...
discrim_means={
    "CC": [[7.08, 7.04, 7.12, 7.24, 7.24, 7.24, 7.24, 7.24, 7.24, 7.24, 7.24, 7.24, 7.24, 7.24, 7.24, 7.24, 7.24, 7.24, 7.24, 7.24], 
           [7.24, 7.68, 7.68, 7.56, 7.68, 7.68, 7.68, 7.68, 7.72, 7.76, 7.68, 7.68, 7.68, 7.68, 7.68, 7.68, 7.68, 7.68, 7.68, 7.76]], 
           
    "CN": [[7.84, 7.76, 7.76, 7.84, 7.84, 7.84, 7.84, 7.84, 7.84, 7.84, 7.84, 7.84, 7.84, 7.84, 7.84, 7.84, 7.84, 7.84, 7.84, 7.84], 
           [6.44, 7.36, 7.84, 7.84, 7.92, 7.92, 7.84, 7.84, 7.84, 7.84, 7.84, 7.84, 7.84, 7.84, 7.84, 7.84, 7.84, 7.84, 7.84, 7.84]], 
           
    "CS": [[7.16, 7.08, 7.24, 7.24, 7.36, 7.36, 7.4, 7.32, 7.4, 7.4, 7.44, 7.4, 7.44, 7.4, 7.44, 7.4, 7.44, 7.4, 7.44, 7.4], 
           [6.36, 7.16, 7.68, 7.56, 7.4, 7.4, 7.36, 7.36, 7.28, 7.36, 7.36, 7.4, 7.36, 7.4, 7.4, 7.4, 7.36, 7.4, 7.36, 7.4]], 
           
    "NC": [[5.92, 5.92, 5.92, 5.84, 5.92, 5.92, 5.84, 5.8, 5.72, 5.76, 5.68, 5.68, 5.68, 5.68, 5.68, 5.68, 5.68, 5.68, 5.68, 5.68], 
           [7.48, 7.12, 7.12, 6.76, 6.48, 6.44, 6.44, 6.36, 6.36, 6.28, 6.32, 6.2, 6.24, 6.2, 6.2, 6.2, 6.2, 6.2, 6.2, 6.24]], 
    
    "NN": [[5.72, 5.76, 5.88, 5.96, 6.08, 6.08, 6.08, 6.04, 6.08, 6.08, 6.12, 6.12, 6.12, 6.12, 6.12, 6.12, 6.12, 6.12, 6.12, 6.12], 
           [6.4, 6.32, 6.28, 6.4, 6.24, 6.36, 6.28, 6.32, 6.28, 6.28, 6.28, 6.32, 6.28, 6.32, 6.28, 6.32, 6.28, 6.32, 6.32, 6.32]], 
           
    "NS": [[6.0, 6.2, 6.32, 6.36, 6.44, 6.44, 6.4, 6.36, 6.48, 6.28, 6.32, 6.32, 6.28, 6.24, 6.2, 6.2, 6.24, 6.24, 6.24, 6.24], 
           [6.52, 7.16, 7.04, 7.16, 6.88, 6.64, 6.48, 6.28, 6.16, 6.28, 6.16, 6.2, 6.16, 6.16, 6.24, 6.32, 6.32, 6.32, 6.32, 6.32]], 
           
    "SC": [[5.88, 6.0, 5.88, 5.92, 5.8, 5.76, 5.68, 5.6, 5.56, 5.6, 5.64, 5.64, 5.6, 5.6, 5.64, 5.6, 5.6, 5.64, 5.6, 5.6], 
           [7.12, 7.32, 7.16, 6.6, 6.6, 6.36, 6.4, 6.24, 6.16, 6.2, 6.12, 6.16, 6.16, 6.12, 6.12, 6.16, 6.12, 6.12, 6.16, 6.12]], 
           
    "SN": [[5.6, 5.76, 5.84, 5.76, 5.72, 5.64, 5.6, 5.6, 5.56, 5.56, 5.56, 5.56, 5.56, 5.56, 5.56, 5.56, 5.56, 5.56, 5.56, 5.56], 
           [6.44, 6.2, 6.16, 6.08, 6.08, 5.96, 5.88, 5.84, 5.8, 5.76, 5.76, 5.76, 5.76, 5.76, 5.76, 5.84, 5.76, 5.76, 5.76, 5.76]], 
           
    "SS": [[5.6, 5.76, 5.76, 5.88, 5.84, 5.8, 5.56, 5.48, 5.48, 5.32, 5.24, 5.28, 5.2, 5.2, 5.08, 5.04, 5.04, 5.04, 5.04, 4.84], 
           [6.36, 6.48, 6.56, 6.16, 6.04, 5.8, 5.6, 5.48, 5.44, 5.08, 5.28, 4.92, 4.96, 4.92, 4.92, 4.92, 4.92, 4.92, 4.92, 4.92]]
}

basic_means={
    "CC": [[6.36, 6.6, 6.52, 6.68, 6.8, 6.76, 6.76, 6.76, 6.8, 6.72, 6.76, 6.72, 6.68, 6.64, 6.64, 6.64, 6.64, 6.64, 6.64, 6.64], 
           [6.92, 6.96, 6.96, 6.96, 6.88, 7.0, 6.92, 6.92, 6.92, 7.04, 6.84, 6.84, 6.84, 6.84, 6.8, 6.76, 6.76, 6.76, 6.76, 6.76]], 
    
    "CN": [[6.0, 6.16, 6.24, 6.32, 6.32, 6.32, 6.36, 6.36, 6.36, 6.36, 6.36, 6.36, 6.36, 6.36, 6.36, 6.36, 6.36, 6.36, 6.36, 6.36], 
           [6.16, 6.48, 6.6, 6.56, 6.68, 6.68, 6.6, 6.6, 6.64, 6.6, 6.56, 6.6, 6.6, 6.56, 6.56, 6.56, 6.56, 6.52, 6.52, 6.48]], 
    
    "CS": [[5.96, 6.0, 5.96, 5.96, 5.96, 5.92, 5.88, 5.76, 5.84, 5.72, 5.72, 5.68, 5.68, 5.68, 5.64, 5.64, 5.68, 5.56, 5.4, 5.12], 
           [5.32, 5.84, 5.92, 6.12, 6.04, 5.96, 5.84, 6.0, 5.8, 5.84, 5.72, 5.64, 5.68, 5.64, 5.6, 5.44, 5.36, 4.96, 4.72, 4.16]], 
    
    "NC": [[5.4, 5.6, 5.52, 5.64, 5.48, 5.48, 5.24, 5.2, 5.0, 4.96, 4.88, 4.88, 4.92, 4.96, 4.96, 4.96, 5.0, 5.04, 5.08, 5.12], 
           [6.8, 6.44, 6.4, 6.32, 6.32, 5.92, 6.08, 5.68, 5.8, 5.44, 5.48, 5.4, 5.36, 5.36, 5.44, 5.4, 5.44, 5.48, 5.52, 5.56]], 
           
    "NN": [[5.48, 5.72, 5.72, 5.72, 5.8, 5.88, 5.84, 5.84, 5.8, 5.8, 5.8, 5.8, 5.8, 5.8, 5.8, 5.8, 5.8, 5.8, 5.76, 5.72], 
           [6.08, 6.08, 6.2, 6.04, 6.16, 6.08, 6.2, 6.12, 6.08, 6.04, 6.08, 6.04, 6.04, 6.04, 6.04, 6.04, 6.04, 6.0, 5.96, 5.88]], 
           
    "NS": [[5.76, 5.72, 5.88, 5.84, 5.8, 5.6, 5.56, 5.56, 5.44, 5.32, 5.36, 5.36, 5.36, 5.4, 5.36, 5.36, 5.4, 5.36, 5.36, 5.2], 
           [5.28, 5.88, 5.92, 6.2, 6.04, 5.88, 5.84, 5.68, 5.68, 5.52, 5.36, 5.44, 5.44, 5.4, 5.44, 5.4, 5.36, 5.36, 5.12, 4.88]], 
           
    "SC": [[5.24, 5.28, 5.08, 5.08, 4.68, 4.48, 4.28, 4.16, 4.04, 4.0, 3.88, 4.04, 3.8, 3.76, 3.76, 3.68, 3.64, 3.64, 3.64, 3.56], 
           [6.88, 6.36, 6.12, 5.88, 5.72, 5.28, 5.12, 4.64, 4.6, 4.48, 4.4, 4.24, 4.44, 4.12, 4.08, 4.04, 4.0, 3.96, 3.92, 3.88]], 
    
    "SN": [[5.44, 5.48, 5.44, 5.36, 5.24, 5.24, 5.2, 5.0, 4.92, 4.92, 4.88, 4.92, 4.88, 4.84, 4.84, 4.84, 4.84, 4.8, 4.88, 4.56], 
           [6.2, 6.16, 6.16, 6.0, 5.8, 5.64, 5.68, 5.52, 5.36, 5.28, 5.36, 5.16, 5.32, 5.16, 5.08, 5.12, 5.12, 5.08, 4.96, 4.96]], 
    
    "SS": [[5.08, 5.28, 5.32, 5.44, 5.16, 5.08, 5.0, 5.04, 4.96, 5.04, 4.92, 4.92, 4.88, 4.88, 4.84, 4.84, 4.92, 4.92, 4.8, 4.64], 
           [5.68, 5.72, 5.76, 5.6, 5.6, 5.32, 5.36, 5.24, 5.32, 5.16, 5.24, 5.12, 5.2, 5.08, 5.16, 5.04, 4.84, 4.84, 4.68, 3.84]]
}
...
if __name__ == "__main__":
    ...
    # with open("basic_gc_final.json", 'w') as b:
    #     json.dump(basic_final_avg, b)
    # with open("basic_gc_rounds.json", 'w') as f:
