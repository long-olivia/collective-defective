...
with open("meta_rounds.json") as file:
    no_name=json.load(file)

with open("self_meta_rounds.json") as file:
    name=json.load(file)

with open("meta_basic_round_SE.json") as file:
    no_ci=json.load(file)

with open("meta_self_rounds_SE.json") as file:
...
plt.suptitle('Study 3: Per Round Model Contributions for Llama 4 Maverick, Four-Player Condition')
plt.savefig('study3_meta', dpi=600)